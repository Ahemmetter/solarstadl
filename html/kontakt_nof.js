...
$(document).ready( function() {
	$('#Bild41A').bind('click', function() { pageTracker._trackPageview('/outgoing/mailto:info@solarstadl.de'); } );
	$('#Bild42A').bind('click', function() { pageTracker._trackPageview('/outgoing/facebook.com/solarstadl'); } );
	$('#Bild47A').bind('click', function() { pageTracker._trackPageview('/outgoing/https://www.youtube.com/channel/UC8MyMyktS1rZebbiWPy5p9A'); } );
});
// End Analytics
