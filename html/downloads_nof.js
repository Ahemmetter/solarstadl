...
$(document).ready( function() {
	$('#Zelle33Link1').bind('click', function() { pageTracker._trackPageview('/downloads/KfW-ab 17.02.2016.pdf'); } );
	$('#Zelle999Link1').bind('click', function() { pageTracker._trackPageview('/downloads/KarlHemmetter-SMA.pdf'); } );
	$('#Zelle35Link1').bind('click', function() { pageTracker._trackPageview('/downloads/KarlHemmetter-Powerrouter.pdf'); } );
	$('#Zelle998Link1').bind('click', function() { pageTracker._trackPageview('/downloads/CO2-Minderungsprogramm der N-ergie.pdf'); } );
	$('#Zelle1216Link1').bind('click', function() { pageTracker._trackPageview('/downloads/S10_Mini.zip'); } );
	$('#Zelle1217Link1').bind('click', function() { pageTracker._trackPageview('/downloads/S10_E.zip'); } );
	$('#Zelle1218Link1').bind('click', function() { pageTracker._trackPageview('/downloads/CE Konformität Wallbox E3DC_2014-10-15.pdf'); } );
});
// End Analytics
...
ButtonsImageMapping["Navigationsleiste2"] = {
	...
	"Navigationsschaltflaeche11" : { image: "../assets/images/autogen/Downloads_Hp_highlighted.png", rollover: "../assets/images/autogen/Downloads_HRp_highlightedOver.png", w: 120, h: 57 },
